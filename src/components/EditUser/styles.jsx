...
export const ContainerPageEdit = styled.div`
    width: 100vw;
    height: 100vh;
    position: absolute;
    top: 0;
...
export const ContainerPopUpEdit = styled.div`
    position: relative;
    width: 30%;
    height: auto;
...
export const TextTitleEdit = styled.h1`
    color: #B57EDC;
    margin-bottom: 1rem;
    font-size: 24px;
`;
...
`;
export const BtnEnterEdit = styled.button`
